      ...
      <div class="container-fluid">
        ...
        @foreach($blog as $blogs)
          ...
          <div class="item">
            ...
            <img src="{{asset('storage/blog/' .$blogs->blog_img)}}" >
            ...
            <div class="item-content">
              <div class="main-content">
                ...
                <a href="post-details.html"><h4>{{ $blogs->blog_detail}}</h4></a>
                <ul class="post-info">
                  <li><a href="#">{{$blogs->author_name}}</a></li>
                  <li><a href="#">{{$blogs->blog_date}}</a></li>
                  <li><a href="#">{{$blogs->blog_comment}}</a></li>
                </ul>
              </div>
            </div>
          </div>
