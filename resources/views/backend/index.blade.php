...
@section('style')
<!-- jvectormap css -->
<link href="{{ asset('backend/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet" type="text/css" />
<!-- Datepicker css -->
...
<script src="{{ asset('backend/assets/js/custom/custom-dashboard-social.js') }}"></script>
@endsection
