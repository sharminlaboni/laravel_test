                      ...
                      <div class="form-group">
                        ...
                        <label for="user">user name</label>
                         ...
                         @foreach($users as $user)
                           <option value="{{$user->id}}">{{$user->nme}}</option>
                          @endforeach
                        </select>
                        </div> 
                        <div class="form-group">
                                <label for="exampleInputEmail1">Enter author name</label>
                                <input type="text" class="form-control" name="author_name" value="{{ $blog->author_name }}" id="exampleInputEmail1" placeholder="Enter author_name">
                            </div>
                            <div class="form-group">
